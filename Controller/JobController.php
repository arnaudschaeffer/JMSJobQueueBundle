...
class JobController extends AbstractController
{
    ...
    #[\Symfony\Component\Routing\Annotation\Route(path: '/{id}', name: 'jms_jobs_details')]
    ...
    #[\Symfony\Component\Routing\Attribute\Route(path: '/{id}/retry', name: 'jms_jobs_retry_job')]
